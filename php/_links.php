...
$link['YOUR_WEBSITE'] = $config['site_url'] . 'your-website';
$link['YOUR_WEBSITE_EDITOR'] = $config['site_url'] . 'your-website/editor';
$link['YOUR_WEBSITE_DASHBOARD'] = $config['site_url'] . 'your-website/dashboard';
$link['YOUR_WEBSITE_PUBLIC'] = $config['site_url'] . 'site';
$link['YOUR_WEBSITE_CHECKOUT'] = $config['site_url'] . 'your-website/checkout';
$link['ECOM_APP'] = $config['site_url'] . 'ecom';
$link['SERVICE_APP'] = $config['site_url'] . 'service';
$link['ECOM_ADMIN'] = $config['site_url'] . 'ecom/admin/dashboard';
$link['SERVICE_ADMIN'] = $config['site_url'] . 'service/admin/dashboard';
