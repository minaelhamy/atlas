...
<?php include '../sidebar.php'; ?>
            ...
            <div class="quick-card card">
                <div class="card-body">
                    <div class="dataTables_wrapper">
                        <table class="table table-striped" id="ajax_datatable" data-jsonfile="transaction.php" data-order-col="6">
                            <thead>
                            <tr>
                                <th class="no-sort"><?php _e('Title') ?></th>
                                <th class="no-sort"><?php _e('Username') ?></th>
                                <th class="no-sort"><?php _e('Amount') ?></th>
                                <th class="no-sort"><?php _e('Premium') ?></th>
                                <th class="no-sort"><?php _e('Status') ?></th>
                                <th class="no-sort"><?php _e('Pay Method') ?></th>
                                <th><?php _e('Time') ?></th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="deleteTransaction"
