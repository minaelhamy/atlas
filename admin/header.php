...
<head>
    ...
    <meta name="author" content="<?php echo htmlspecialchars($config['site_title']); ?>" />
    ...
    <script>
        var ajaxurl = '<?php echo str_replace(['https:','http:'],['',''], ADMINURL)."admin_ajax.php" ?>';
        var sidepanel_ajaxurl = '<?php echo str_replace(['https:','http:'],['',''], ADMINURL)."ajax_sidepanel.php"; ?>';
    </script>
</head>
<body>
