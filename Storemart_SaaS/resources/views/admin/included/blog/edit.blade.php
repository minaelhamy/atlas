                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ $getblog->title }}" placeholder="{{ trans('labels.title') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ helper::image_path($getblog->image) }}"
                                    class="img-fluid rounded hight-50 mt-1 object" alt="">
                            </div>
                            <div class="mt-3 {{ session()->get('direction') == '2' ? 'text-start' : 'text-end' }}">
                                <a href="{{ URL::to('admin/blogs') }}"
                                    class="btn btn-danger px-sm-4">{{ trans('labels.cancel') }}</a>
                                <button
                                    class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_blogs', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}"
