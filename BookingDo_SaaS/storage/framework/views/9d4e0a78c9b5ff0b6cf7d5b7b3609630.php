    ...
    <div class="footer-bg-color bg-changer overflow-hidden">
        <div class="container footer-container">
            <div class="row g-3">
                <div class="col-xl-4 col-lg-4">
                    <div>
                        ...
                        <a href="<?php echo e(URL::to('/')); ?>">
                            <img src="" height="50" alt="" id="footerlogoimage">
                        </a>
                ...
                <div class="col-xl-4 col-lg-4 footer-contain">
                    <div class="contact-box p-sm-5 p-4">
                        ...
                        <p class="pb-2 fw-500 fs-7">
                            <a href="mailto:<?php echo e(helper::appdata('')->email); ?>" class="d-flex align-items-center gap-2">
                        ...
                        <p class="pb-2 fw-500 fs-7">
                            <a href="tel:<?php echo e(helper::appdata('')->contact); ?>" class="d-flex align-items-center gap-2">
                        ...
                        <p class="fw-500 fs-7">
                            <a href="https://www.google.com/maps/place/<?php echo e(helper::appdata('')->address); ?>"
                                class="d-flex gap-2">
            ...
            <?php if(@helper::checkaddons('whatsapp_message')): ?>
                <?php if(whatsapp_helper::whatsapp_message_config('')->whatsapp_chat_on_off == 1): ?>
                    <?php if(whatsapp_helper::whatsapp_message_config('')->whatsapp_number != null &&
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="msg_header">
                                    <h6><?php echo e(helper::appdata('')->web_title); ?></h6>
                                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/envato_bookingdo/BookingDo_Addon_v4.3/resources/views/landing/layout/footer.blade.php ENDPATH**/ ?>