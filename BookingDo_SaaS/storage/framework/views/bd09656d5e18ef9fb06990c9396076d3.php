<?php $__env->startSection('content'); ?>
                ...
                <div class="banner-page text-center">
                    <div class="banner-text">
                        ...
                        <div class="mt-5 d-flex flex-wrap justify-content-center align-items-center gap-3">
                            ...
                            <?php if(helper::planlist()->count() > 0): ?>
                                <a href="<?php if(env('Environment') == 'sendbox'): ?> https://1.envato.market/KeRzWn <?php else: ?> <?php echo e(URL::to('/#pricing-plans')); ?> <?php endif; ?>"
                        ...
                        <div class="project-management-text col-lg-6 mb-3 order-md-0 order-2">
                            <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000" direction="false">
                                <div class="<?php echo e($key); ?>">
                                    <h5
                                        class="work-title mb-3 col-md-auto color-changer landing-rtl <?php echo e(session()->get('direction') == 2 ? 'rtl text-start' : 'ltr text-end'); ?>">
        ...
        <div class="container">
            <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                ...
                <div class="text-center mt-4">
                    ...
                    <?php if(helper::planlist()->count() > 0): ?>
                        <a href="<?php if(env('Environment') == 'sendbox'): ?> https://1.envato.market/KeRzWn <?php else: ?> <?php echo e(URL::to('/#pricing-plans')); ?> <?php endif; ?>"
                            class="btn-secondary rounded-2 fs-7" <?php if(env('Environment') == 'sendbox'): ?> target="_blank" <?php endif; ?>>
                            <?php echo e(trans('labels.buy_now')); ?>
                ...
                <div class="container card-section-container">
                    ...
                    <div class="d-flex justify-content-center mt-sm-5 mt-4 view-all-btn" data-aos="fade-up"
                        ...
                        <a href="<?php echo e(URL::to('/stores')); ?>"
                            class="btn-secondary rounded-2 fs-7"><?php echo e(trans('landing.view_all')); ?>
    ...
    <?php if(@helper::checkaddons('vendor_app')): ?>
        <?php if(!empty($app_settings)): ?>
            <?php if($app_settings->mobile_app_on_off == 1): ?>
                                    ...
                                    <div class="pricingTable rounded-4 card bg-primary-rgb">
                                        <div class="card-body p-sm-4">
                                            ...
                                            <?php if($plan->tax != null && $plan->tax != ''): ?>
                                                <small
                                                    class="text-danger"><?php echo e(trans('labels.exclusive_all_taxes')); ?></small><br>
                                            <?php else: ?>
                                                ...
                                                <li class="color-changer">
                                                    ...
                                                    <p class="fs-15px"><?php echo e(count($themes)); ?>
                                                        ...
                                                        <span> <a class="text-dark color-changer"
                                                                onclick="themeinfo('<?php echo e($plan->id); ?>','<?php echo e($plan->themes_id); ?>','<?php echo e($plan->name); ?>')"
                        ...
                        <?php $__currentLoopData = $funfacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-3 col-sm-6">
                                <div class="counter d-flex align-items-center justify-content-center flex-column gap-1">
                                    ...
                                    <h3 class="px-3 m-0"><?php echo e($fact->description); ?></h3>
        ...
        <?php if(@helper::checkaddons('blog')): ?>
            <section id="blogs" class="bg-primary-rgb bg-changer">
                ...
                <div class="container blog-container">
                    <div class="blog-card">
                        <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                            <h5 class="latest-blog color-changer"><?php echo e(trans('landing.blog_section_title')); ?>
                        ...
                        <div class="d-flex justify-content-center view-all-btn" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <a href="<?php echo e(URL::to('/blogs')); ?>"
                                class="btn-secondary rounded-2 fs-7"><?php echo e(trans('landing.view_all')); ?></a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="email-icon-text-box bg-primary-rgb card border-0 rounded-3 h-100">
                                            <div class="card-body">
                                                ...
                                                <p class="infogolio-email p-0 mt-2 m-0 text-center"><a
                                                        href="mailto:<?php echo e(helper::appdata('')->email); ?>"
                                                        class="color-changer"><?php echo e(helper::appdata('')->email); ?></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-lg-6">
                                        <div class="email-icon-text-box bg-primary-rgb card border-0 rounded-3 h-100">
                                            <div class="card-body">
                                                ...
                                                <p class="infogolio-email p-0 mt-2 m-0 text-center"><a
                                                        href="tel:<?php echo e(helper::appdata('')->contact); ?>"
                                                        class="color-changer"><?php echo e(helper::appdata('')->contact); ?></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-12">
                                        <div class="email-icon-text-box bg-primary-rgb card border-0 rounded-3 h-100">
                                            <div class="card-body">
                                                ...
                                                <p class="infogolio-email p-0 mt-2 m-0 text-center"><a
                                                        href="https://www.google.com/maps/place/<?php echo e(helper::appdata('')->address); ?>"
                                                        target="_blank"
                                                        class="color-changer"><?php echo e(helper::appdata('')->address); ?></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div data-aos="fade-down" data-aos-delay="100" data-aos-duration="1000">
                        <form class="rgb-secondary-light rounded-3 px-sm-4 px-3 py-4" action="<?php echo e(URL::To('/inquiry')); ?>"
                            ...
                            <div class="row g-3 mt-3">
                                <div class="col-md-6">
                                    <label for="name"
                                        class="form-label contact-form-label text-dark"><?php echo e(trans('landing.name')); ?></label>
                                    <input type="text" class="form-control fs-7" name="name"
                                        placeholder="<?php echo e(trans('landing.name')); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="email"
                                        class="form-label contact-form-label text-dark"><?php echo e(trans('landing.email')); ?></label>
                                    <input type="email" class="form-control fs-7" name="email"
                                        placeholder="<?php echo e(trans('landing.email')); ?>" required>
                                </div>
                                <div class="col-12">
                                    <label for="inputAddress"
                                        class="form-label contact-form-label text-dark"><?php echo e(trans('landing.mobile')); ?></label>
                                    <input type="number" class="form-control fs-7" name="mobile"
                                        placeholder="<?php echo e(trans('landing.mobile')); ?>" required>
                                </div>
                                <div class="col-12">
                                    <label for="message"
                                        class="form-label contact-form-label text-dark"><?php echo e(trans('landing.message')); ?></label>
                                    <textarea class="form-control fs-7" rows="3" name="message" placeholder="<?php echo e(trans('landing.message')); ?>"
                                        required></textarea>
                                </div>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/envato_bookingdo/BookingDo_Addon_v4.3/resources/views/landing/index.blade.php ENDPATH**/ ?>