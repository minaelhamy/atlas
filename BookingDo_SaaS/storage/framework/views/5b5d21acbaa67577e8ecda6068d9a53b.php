<table class="table table-striped table-bordered py-3 zero-configuration w-100">
    ...
    <tbody>
        <?php
            $i = 1;
        ?>
        <?php $__currentLoopData = $getbookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="fs-7 align-middle">
                    ...
                    <?php if($transaction->payment_type == 'banktransfer'): ?>
                        <?php if($transaction->status == 2): ?>
                            <span class="badge bg-success">
                                <?php echo e(helper::date_formate($transaction->purchase_date, $transaction->vendor_id)); ?>
                ...
                <td>
                    <?php if($transaction->payment_type == 'banktransfer'): ?>
                        <?php if($transaction->status == 2): ?>
                            <span class="badge bg-danger">
                                <?php echo e(helper::date_formate($transaction->expire_date, $transaction->vendor_id)); ?>
                    ...
                    <?php else: ?>
                        <span class="badge bg-danger">
                            <?php echo e($transaction->expire_date == '' ? '-' : helper::date_formate($transaction->expire_date, $transaction->vendor_id)); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/envato_bookingdo/BookingDo_Addon_v4.3/resources/views/admin/admintransaction.blade.php ENDPATH**/ ?>