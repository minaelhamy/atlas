                    ...
                    <?php if(helper::available_language('')->count() > 1): ?>
                        <div class="language-button-icon d-xl-none d-block">
                            <div class="p-0 lag-btn dropdown">
                                ...
                                <div class="dropdown-menu rounded-1 mt-2 p-0 border-0 overflow-hidden bg-body-secondary shadow <?php echo e(session()->get('direction') == '2' ? 'min-dropdown-rtl' : 'min-dropdown-ltr'); ?>"
                                        ...
                                        <li>
                                            <a class="dropdown-item text-dark d-flex align-items-center p-2 gap-2"
                                                ...
                                                <img src="<?php echo e(helper::image_path($languagelist->image)); ?>" alt=""
                                                    class="lag-img"> <?php echo e($languagelist->name); ?>
                ...
                <?php if(@helper::checkaddons('currency_settigns')): ?>
                    <?php if(helper::available_currency('')->count() > 1): ?>
                        <div class="dropdown lag-btn">
                            ...
                            <ul
                                class="dropdown-menu p-0 bg-body-secondary border-0 mt-2 <?php echo e(session()->get('direction') == 2 ? 'drop-menu-rtl' : 'drop-menu'); ?>">
                ...
                <div class="d-none w-100 d-xl-block mx-auto">
                    <ul class="navbar-nav justify-content-center mb-2 mb-lg-0">
                        <li class="nav-item dropdown px-2">
                            <a class="nav-link text-white fs-15 fw-500 active" href="<?php echo e(URL::to('/')); ?>"
                                role="button">
                        ...
                        <li class="nav-item dropdown px-2">
                            <a class="nav-link text-white fs-15 fw-500" href="<?php echo e(URL::to('/#features')); ?>"
                                role="button">
                        ...
                        <?php if(@helper::checkaddons('subscription')): ?>
                            <li class="nav-item dropdown px-2">
                                <a class="nav-link text-white fs-15 fw-500" href="<?php echo e(URL::to('/#our-stores')); ?>"
                                    role="button">
                            ...
                            <li class="nav-item dropdown px-2">
                                <a class="nav-link text-white fs-15 fw-500" href="<?php echo e(URL::to('/#pricing-plans')); ?>"
                                    role="button">
                        ...
                        <?php if(@helper::checkaddons('blog')): ?>
                            <li class="nav-item dropdown px-2">
                                <a class="nav-link text-white fs-15 fw-500" href="<?php echo e(URL::to('/#blogs')); ?>"
                                    role="button">
                        ...
                        <?php endif; ?>
                        <li class="nav-item dropdown px-2">
                            <a class="nav-link text-white fs-15 fw-500" href="<?php echo e(URL::to('/#contact-us')); ?>"
                                role="button">
                    ...
                    <?php if(@helper::checkaddons('language')): ?>
                        <?php if(helper::available_language('')->count() > 1): ?>
                            <div class="lag-btn  dropdown rounded-2">
                                ...
                                <ul
                                    class="dropdown-menu mt-2 rounded-1 p-0 border-0 overflow-hidden bg-body-secondary shadow <?php echo e(session()->get('direction') == '2' ? 'min-dropdown-rtl' : 'min-dropdown-ltr'); ?>">
                                    <?php $__currentLoopData = helper::available_language(''); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $languagelist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
...
<div class="offcanvas bg-changer <?php echo e(session()->get('direction') == 2 ? 'offcanvas-end' : 'offcanvas-start'); ?>"
    ...
    <div class="offcanvas-header d-flex justify-content-between align-items-center bg-black bg-changer border-bottom">
        <img src="<?php echo e(helper::image_path(helper::appdata('')->logo)); ?>" height="35px" alt="">
        <button type="button"
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/envato_bookingdo/BookingDo_Addon_v4.3/resources/views/landing/layout/header.blade.php ENDPATH**/ ?>