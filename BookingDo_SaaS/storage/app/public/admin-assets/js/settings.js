...
if (role_type == 1) {
    $('.basicinfo').on('click', function () {
        ...
        if ($(this).attr('data-tab') == 'editprofile') {
...
function add_social_links(icon, link) {
    ...
    var html =
        ...
        icon +
        '" required><p class="input-group-text"></p></div></div><div class="col-md-6 d-flex gap-sm-4 gap-2 align-items-center form-group"><input type="text" class="form-control" name="social_link[]" placeholder="' +
        link +
