...
class LanguageController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.include.language.index', compact('getlanguages', 'currantLang', 'arrLabel', 'arrMessage', 'arrLanding'));
    }
    public function add()
    {
        return view('admin.include.language.add');
    }
    ...
    public function delete(Request $request)
    {
        try {
            ...
            if (file_exists(storage_path('app/public/admin-assets/images/language/' . $language->image))) {
                unlink(storage_path('app/public/admin-assets/images/language/' . $language->image));
            }
            $language->delete();
            return redirect('admin/language-settings')->with('success', trans('messages.success'));
        } catch (\Throwable $th) {
    ...
    public function edit($id)
    {
        ...
        return view('admin.include.language.edit', compact('getlanguage'));
    }
