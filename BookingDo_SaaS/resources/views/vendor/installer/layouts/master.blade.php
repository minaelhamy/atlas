...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="{{ url(env('ASSETPATHURL') . 'installer/img/favicon/favicon-16x16.png') }}" sizes="16x16"/>
        <link rel="icon" type="image/png" href="{{ url(env('ASSETPATHURL') . 'installer/img/favicon/favicon-32x32.png') }}" sizes="32x32"/>
        <link rel="icon" type="image/png" href="{{ url(env('ASSETPATHURL') . 'installer/img/favicon/favicon-96x96.png') }}" sizes="96x96"/>
        <link href="{{ url(env('ASSETPATHURL') . 'installer/css/style.min.css') }}" rel="stylesheet"/>
        @yield('style')
        <script>
            ...
            <div class="box">
                ...
                <div class="main">
                    @if (session('message'))
                        ...
                        <p style="color:red;"><strong>Default Admin Created : admin@gmail.com / 123456</strong></p>
                    @endif
