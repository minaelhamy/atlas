...
<div class="d-flex justify-content-between align-items-center">
                ...
                <h5 class="text-capitalize fw-600 fs-4 color-changer">{{ trans('labels.inquiries') }}</h5>

                <div class="d-flex align-items-center" >
                    <!-- Bulk Delete Button -->
                    @if (@helper::checkaddons('bulk_delete'))
                    <button id="bulkDeleteBtn"
                        @if (env('Environment')=='sendbox' ) onclick="myFunction()" @else onclick="deleteSelected('{{ URL::to('admin/contacts/bulk_delete') }}')" @endif class="btn btn-danger hov btn-sm d-none d-flex" tooltip="{{ trans('labels.delete') }}" style="margin-right: 30px;">
