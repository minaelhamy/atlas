                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <label class="form-label fs-7 fw-500 mt-2"
                                    for="service_fake_view_message">{{ trans('labels.service_fake_view_message') }}</label>
                                <span class="text-danger">*</span>
                                <textarea class="form-control" name="service_fake_view_message"
                                    placeholder="{{ trans('labels.service_fake_view_message') }}" required>{{ $settingdata->service_fake_view_message }}</textarea>
                                @if (@helper::checkaddons('product_shop'))
                                    <label class="form-label fs-7 fw-500 mt-2"
                                        for="product_fake_view_message">{{ trans('labels.product_fake_view_message') }}</label>
                                    <span class="text-danger">*</span>
                                    <textarea class="form-control" name="product_fake_view_message"
                                        placeholder="{{ trans('labels.product_fake_view_message') }}" required>{{ $settingdata->product_fake_view_message }}</textarea>
                                @endif
                            </div>
                            <div class="col-md-6">
