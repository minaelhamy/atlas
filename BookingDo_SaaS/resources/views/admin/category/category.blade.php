                        ...
                        <table class="table table-striped table-bordered py-3 zero-configuration w-100 dataTable no-footer">
                            ...
                            <tbody id="tabledetails" data-url="{{ url('admin/categories/reorder_category') }}">
                                ...
                                @foreach ($allcategories as $category)
                                    ...
                                    <tr class="fs-7 row1 align-middle" id="dataid{{ $category->id }}" data-id="{{ $category->id }}">
                                        ...
                                        <td><img src="{{ helper::image_path($category->image) }}"
                                        ...
                                        <td>
                                            ...
                                            @if ($category->is_available == '1')
                                                ...
                                                <a href="javascript:void(0)" tooltip="{{ trans('labels.active') }}"
                                                    ...
                                                    class="btn btn-sm hov btn-outline-success {{ Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}"><i
                                            ...
                                            @else
                                                ...
                                                <a href="javascript:void(0)" tooltip="{{ trans('labels.inactive') }}"
                                                    ...
                                                    class="btn btn-sm btn-outline-danger hov {{ Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}"><i
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-2 flex-wrap">
                                                <a href="{{ URL::to('/admin/categories/edit-' . $category->slug) }}"
                                                    ...
                                                    class="btn btn-info hov btn-sm {{ Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}">
                                                ...
                                                <a href="javascript:void(0)" tooltip="{{ trans('labels.delete') }}"
                                                    ...
                                                    class="btn btn-danger hov btn-sm {{ Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'delete') == 1 ? '' : 'd-none') : '' }}">
