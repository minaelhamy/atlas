...
@section('content')
    <div class="d-flex align-items-center mb-3">
        <h5 class="text-capitalize color-changer">{{ trans('labels.payment_settings') }}</h5>
    </div>
                            ...
                            <form action="{{ URL::to('admin/payment/update') }}" method="POST" class="payments"
                                ...
                                @if ($systemAddonActivated)
                                    ...
                                    <div class="payment-accordian card rounded border mb-3 handle">
                                        <h2 class="card-header color-changer d-flex align-items-center rounded border-0 justify-content-between"
                                            ...
                                            <div>
                                                ...
                                                @if ($transaction_type != '1' && $transaction_type != '16')
                                            ...
                                            <a class="cursor-pointer color-changer" tooltip="{{ trans('labels.move') }}"><i
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                @elseif($transaction_type == 1 || $transaction_type == 16)
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="image" class="form-label">
                                                                {{ trans('labels.image') }} </label>
                                                ...
                                                <div class="form-group d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button
                                                        class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_payment', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}"
