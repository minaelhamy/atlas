                ...
                <div class="card border-0 box-shadow">
                    <div class="card-header p-3 bg-secondary">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="text-capitalize fw-600 text-dark color-changer">{{ trans('labels.wizz_chat_settings') }}
                            </h5>
                            <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label class="form-label">{{ trans('labels.wizz_chat_info') }}
                                    <a href="https://app.wizzchat.com/"
                                        target="_blank">{{ trans('labels.click_here') }}</a>
                                </label>
