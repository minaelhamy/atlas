                    ...
                    <form action="{{ URL::to('admin/currencys/currency_update-' . $editcurrency->id) }}" method="POST">
                        ...
                        <div class="row">
                             <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="currency" id="currency" value="{{ $editcurrency->currency}}"
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="currency_symbol" value="{{  $editcurrency->currency_symbol }}"
