    ...
    <div class="row mt-3">
        ...
        <div class="col-12">
            <div class="card border-0 box-shadow">
                <div class="card-body">
                    <form action="{{ URL::to('admin/currencys/currency_store') }}" method="POST">
                        @csrf
                        <div class="row">
                            
                            <div class="form-group col-md-6">
                                <input type="hidden" name="code" id="code">
                                <label class="form-label">{{ trans('labels.code') }}<span class="text-danger"> *
                                    </span></label>
                                <input type="text" class="form-control" name="currency" id="currency" value="{{ old('name') }}"
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="currency_symbol" value="{{ old('name') }}"
