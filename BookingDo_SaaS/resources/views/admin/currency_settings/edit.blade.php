                    ...
                    <form action="{{ URL::to('admin/currency-settings/update-' . $editcurrency->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="currency" value="{{$editcurrency->currency}}"
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input form-check-input-secondary" type="radio"
                                        name="currency_position" id="radio"
                                        value="1"
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input form-check-input-secondary" type="radio"
                                        name="currency_position" id="radio1"
                                        value="2"
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input form-check-input-secondary" type="radio"
                                        name="currency_space" id="currency_space"
                                        value="1"
                                        {{ $editcurrency->currency_space == '1' ? 'checked' : '' }} />
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input form-check-input-secondary" type="radio"
                                        name="currency_space" id="currency_space1"
                                        value="2"
                                        {{ $editcurrency->currency_space == '2' ? 'checked' : '' }} />
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input form-check-input-secondary" type="radio"
                                        name="decimal_separator" id="comma"
                                        value="2"
