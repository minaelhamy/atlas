        ...
        <div class="col-12">
            ...
            <div class="card border-0 box-shadow">
                <div class="card-header p-3 bg-secondary">
                    <h5 class="text-capitalize fw-600 text-dark color-changer">{{ trans('labels.pwa_settings') }}</h5>
                </div>
                    ...
                    <form method="POST" action="{{ URL::to('admin/pwasettings') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input id="pwa-switch" type="checkbox" class="checkbox-switch" name="pwa"
                                    value="1" {{ $settingdata->pwa == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label class="form-label">{{ trans('labels.app_logo') }}
                                ...
                                <img class="img-fluid rounded hw-70 mt-1 object-fit-contain"
                                    src="{{ helper::image_path(@$settingdata->app_logo) }}" alt="">

                            </div>

                            <div class="form-group col-sm-6">

                                <label class="form-label">{{ trans('labels.app_title') }}</label>

                                <input type="text" class="form-control" name="app_title"
                                    value="{{ $settingdata->app_title }}"
                                    placeholder="{{ trans('labels.app_title') }}" required>

                            </div>

                            <div class="form-group col-sm-6">

                                <label class="form-label">{{ trans('labels.app_name') }}</label>

                                <input type="text" class="form-control" name="app_name"
                                    value="{{ $settingdata->app_name }}" placeholder="{{ trans('labels.app_name') }}"
                                    required>
