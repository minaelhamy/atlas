        ...
        <div class="container footer-container">
            <div class="row g-3">
                ...
                <div class="col-xl-2 col-lg-4 col-6 footer-contain">
                    <div>
                        ...
                        {{-- <p class="py-1 fs-7"><a href="{{ URL::to('/blogs') }}">{{ trans('landing.blogs') }}</a></p> --}}

                        {{-- <p class="py-1 fs-7"><a href="{{ URL::to('/faqs') }}">{{ trans('landing.faqs') }}</a>
                        </p> --}}
                        {{-- @if (@helper::checkaddons('subscription'))
                            <p class="py-1 fs-7"><a
                                    href="{{ URL::to('/stores') }}"></a></p>
                        @endif
                        <p class="py-1 fs-7"><a href="{{ URL::to('/contact') }}">{{ trans('landing.contact_us') }}</a>
                        </p> --}}
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 footer-contain">
                    <div class="contact-box p-sm-5 p-4">
                        ...
                        <p class="pb-2 fw-500 fs-7">
                            <a href="mailto:{{ helper::appdata('')->email }}" class="d-flex align-items-center gap-2">
                                <i class="fa-solid fa-envelope fs-5 text-primary-color"></i>
                                {{ helper::appdata('')->email }}
                            </a>
                        </p>
                        <p class="pb-2 fw-500 fs-7">
                            <a href="tel:{{ helper::appdata('')->contact }}" class="d-flex align-items-center gap-2">
            ...
            @if (@helper::checkaddons('whatsapp_message'))
                @if (whatsapp_helper::whatsapp_message_config('')->whatsapp_chat_on_off == 1)
                    @if (whatsapp_helper::whatsapp_message_config('')->whatsapp_number != null &&
