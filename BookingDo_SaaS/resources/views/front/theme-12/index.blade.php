        ...
        <div class="d-flex flex-column h-100 justify-content-center">
            <div class="container">
                <div class="d-flex flex-column flex-md-row h-100">
                    <div class="col-12">
                        <div
                            class="row outline_main_banner bg-gradient g-3 align-items-center justify-content-center p-md-5 p-4">
                            <div class="col-12">
                                <h5 class="fs-5 mb-2 fw-500 text-secondary color-changer">
                                ...
                                <div class="mt-3 w-100">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-xl-2 col-lg-3">
                                            <!-- avatar -->
                                            <ul class="avatar-group mb-0 mx-auto mx-lg-0">
                                        ...
                                        <div class="col-xl-10 col-lg-9">
                                            <div
                                                class="bg-blur  w-100 bg-white bg-opacity-10 border shadow-lg border-light border-opacity-25 p-md-4 p-3">
                        ...
                        <div class="owl-stage carousel">
                            @foreach ($getcategories as $category)
                                <div class="owl-item h-100">
                                    <div class="card mx-1 h-100 rounded-0 overflow-hidden">
                                        <a
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="box-content">
                                                    ...
                                                    <P class="text-center fs-7 fw-500 text-primary-color m-0 text-truncate">
                                                        {{ trans('labels.services') }}
                                                    </P>
                                                    <p
                                                        class="mb-1 text-center text-dark fw-600 text-truncate color-changer">
                                                        {{ $category->name }}
                                                    </p>
                                                </div>
                                            </div>
                            ...
                            @foreach ($choose as $choose)
                                <div class="col-sm-6">
                                    <div class="card rounded-0">
                                        <div class="card-body bg-primary-rgb">
                                            <div class="icon-img-12 rounded-0 mb-3 p-1 bg-primary-rgb">
                                                <img src="{{ helper::image_path($choose->image) }}" alt=""
                                                    class="rounded-0 shadow">
                                            </div>
                                            <h6 class="mt-2 fw-600 text-truncate color-changer">{{ $choose->title }}</h6>
                                            <p class="mb-0 text-muted fs-7 text_truncation2">{{ $choose->description }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    @if ($getservices->count() > 0)
        <section class="service-div w-100">
            <div class="container">
                ...
                <div class="row g-3 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 theme-12">
                    @foreach ($getservices as $service)
                        ...
                        @endphp
                        <div class="col">
                            <div class="card h-100 w-100 border-1 position-relative rounded-0">
                                <div class="overflow-hidden img-over">
                                    @if ($service['service_image'] == null)
                                        <img src="{{ helper::image_path('service.png') }}"
                                            class="w-100 position-relative theme-12-imges" alt="..." height="250px">
                                    @else
                                    ...
                                    @if (helper::appdata($vendordata->id)->online_order == 1)
                                        <a href="{{ URL::to($vendordata->slug . '/booking-' . $service->id) }}"
                                            class="booknow fw-500 fs-7 btn btn-md btn-primary rounded-0 add-to-12 shadow m-0">
                                            {{ trans('labels.book_now') }}
                                        </a>
                                    @else
                                ...
                                <div class="card-footer border-top-0 p-3 pt-0 bg-transparent">
        ...
        <section class="top-category my-5">
            <div class="container">
                ...
                <div class="row g-4 align-items-center justify-content-between">
                    <!-- Listing -->
                    <div class="col-12">
                        <div class="row g-3 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 theme-12">
                            @foreach ($gettoprated as $toprated)
                                ...
                                <div class="col">
                                    <div class="card rounded-0 h-100">
                                        <div class="rounded-0 position-relative overflow-hidden">
                                            <img src="{{ $toprated['service_image'] == null ? helper::image_path('service.png') : helper::image_path($toprated['service_image']->image) }}"
                                                class="card-img-top  theme-12-imges object-fit-cover w-100 rounded-0"
                                                alt="" height="220px">
                                        </div>
                                        @if ($off > 0)
                                            <div class="offer-12">
                                        ...
                                        <div class="card-body position-relative">
                                            @if (helper::appdata($vendordata->id)->online_order == 1)
                                                <a href="{{ URL::to($vendordata->slug . '/booking-' . $toprated->id) }}"
                                                    class="btn btn-primary btn-round mb-0 rounded-0 retting-btn-12 shadow {{ session()->get('direction') == 2 ? 'rtl' : '' }}"><i
                                            ...
                                            {{-- <div class="d-flex g-0 align-items-center justify-content-between">
                                                <div class="d-flex flex-wrap align-items-center gap-1">
                                                    <p class="fs-7 m-0 fw-600 text-truncate">
                    ...
                    <div class="row g-3 justify-content-center">
                        @foreach (helper::footer_features(@$vendordata->id) as $feature)
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="footer-widget border-0 card rounded-0">
