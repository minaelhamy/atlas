                    ...
                    <div class="payment margin-top-30">
                        ...
                        <?php } else { ?>
                            ...
                            if ($user_balance >= $price) { ?>
                                <div class="payment-tab payment-tab-active">
                                    <div class="payment-tab-trigger">
                                        <input name="payment_method_id" class="payment_method_id"
                                               id="<?php _esc("wallet"); ?>"
                            ...
                            foreach ($payment_types as $payment) {
                                ?>
                                <div class="payment-tab <?php if ($i == 0) {
                                    echo 'payment-tab-active';
                                } ?>">
                                    <div class="payment-tab-trigger">
                                        <input name="payment_method_id" class="payment_method_id"
                                               id="<?php _esc($payment['folder']); ?>"
                                               type="radio" value="<?php _esc($payment['id']); ?>"
                                               data-name="<?php _esc($payment['folder']); ?>">
                                        <label for="<?php _esc($payment['folder']); ?>"><?php _esc($payment['title']); ?></label>
                                        <img class="payment-logo <?php _esc($payment['folder']); ?>"
                                             src="<?php _esc($payment['image']); ?>"
                                             alt="<?php _esc($payment['title']); ?>">
                                    </div>
                                    <div class="payment-tab-content">
                                        <?php if ($payment['folder'] != "2checkout" && $payment['folder'] != "wire_transfer") { ?>
                                        ...
                                        <?php if ($payment['folder'] == "stripe") { ?>
                                            <?php if ($config['stripe_payment_mode'] == "both") { ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="radio">
                                                            <input id="recurring-stripe" name="payment_mode"
                                                                   type="radio" value="recurring">
                                                            <label for="recurring-stripe"><span
                                                                        class="radio-label"></span> <?php _e("Recurring Payment") ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="radio">
                                                            <input id="one-time-stripe" name="payment_mode" type="radio"
                                                                   value="one_time" checked="">
                                                            <label for="one-time-stripe"><span
                                                                        class="radio-label"></span> <?php _e("One Time Payment") ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php if ($payment['folder'] == "paypal") { ?>
                                            ...
                                            <?php if ($config['paypal_payment_mode'] == "both") { ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="radio">
                                                            <input id="recurring" name="payment_mode" type="radio"
                                                                   value="recurring">
                                                            <label for="recurring"><span
                                                                        class="radio-label"></span> <?php _e("Recurring Payment") ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="radio">
                                                            <input id="one-time" name="payment_mode" type="radio"
                                                                   value="one_time" checked="">
                                                            <label for="one-time"><span
                                                                        class="radio-label"></span> <?php _e("One Time Payment") ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <?php if ($payment['folder'] == "wire_transfer") { ?>
                                            <div class="quickad-template" id="wire_transfer_payment">
                                                <table class="default-table table-alt-row PaymentMethod-infoTable">
                                                    <tbody>
                                                    <?php if (get_option('wire_transfer_payment_proof', 1)) { ?>
                                                        <tr>
                                                            <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h4 class="PaymentMethod-heading">
                                                                <strong><?php _e("Bank Account details") ?></strong>
                                                            </h4>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h4 class="PaymentMethod-heading">
                                                                <strong><?php _e("Reference") ?></strong></h4>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h4 class="PaymentMethod-heading">
                                                                <strong><?php _e("Amount to send") ?></strong>
                                                            </h4>
                                        ...
                                        <?php if ($payment['folder'] == "2checkout") { ?>
                                            ...
                                            <div class="row payment-form-row">
                                                <div class="col-12">
                                                    <div class="card-label form-group">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               placeholder="<?php _e("CARD NUMBER") ?>"
                                                ...
                                                <div id="checkoutPaymentErrors" class="text-danger"
                                                     style="display:none;">
                                                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <?php if ($show_taxes) { ?>
                                ...
                                foreach ($taxes as $tax) {
                                    ?>
                                    <li>
                                        <?php _esc($tax['name']) ?> <i class="fa fa-question-circle"
                                                                       title="<?php _esc($tax['description']) ?>"
            ...
            $('#subscribeNow').on('click', function (e) {
                ...
                switch (paymentMethod) {
                    ...
                    case 'wire_transfer':
                        ...
                        if(payment_proof)
                        {
                            if (payment_proof.files.length == 0) {
