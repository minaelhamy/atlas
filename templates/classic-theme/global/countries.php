...
<div class="container margin-bottom-50 atlas-public-shell">
    <div class="atlas-public-hero margin-bottom-40">
        <span class="atlas-public-eyebrow"><?php _e("Regions") ?></span>
        <h1><?php _e("Browse countries") ?></h1>
        <p><?php _e("Select a country context to keep moving through the public Atlas experience with the right local view.") ?></p>
    </div>
    <div class="row">
        <?php
