            ...
            <div class="atlas-auth-stage">
                <div class="atlas-auth-story">
                    <div class="atlas-auth-story-inner">
                        <span class="atlas-auth-eyebrow"><?php _e("Reset Access") ?></span>
                        <h1><?php _e("Set a new password and return to your studio") ?></h1>
                        <p><?php _e("Choose a fresh password for your Atlas workspace so you can continue with your brand setup, campaigns, and creative systems without losing traction.") ?></p>

                        <div class="atlas-auth-promise">
                            <div class="atlas-auth-promise-card">
                                <strong><?php _e("Workspace continuity") ?></strong>
                                <span><?php _e("Your projects, brand inputs, and saved outputs stay exactly where you left them.") ?></span>
                            </div>
                            <div class="atlas-auth-promise-card">
                                <strong><?php _e("Secure handoff") ?></strong>
                                <span><?php _e("This reset is tied to your recovery flow so only the intended workspace owner can complete it.") ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="login-register-page atlas-login-page atlas-auth-card">
                    <div class="welcome-text atlas-login-brand atlas-login-brand-left">
                        ...
                        <?php } ?>
                        <span><?php _e("Complete password reset") ?></span>
                    </div>

                    <div class="atlas-auth-heading">
                        <h2><?php _e("Choose a new password") ?></h2>
                        <p><?php _e("We are updating access for the workspace below.") ?></p>
                    </div>
                    ...
                    <form method="post">
                        ...
                        <button class="button full-width button-sliding-icon ripple-effect margin-top-10" name="submit" type="submit"><?php _e("Save New Password") ?> <i class="icon-feather-arrow-right"></i></button>
                    </form>

                    <div class="atlas-login-footnote">
                        <span><a href="<?php url("LOGIN") ?>"><?php _e("Back to Atlas login") ?></a></span>
                    </div>
                </div>
            </div>
        </div>
