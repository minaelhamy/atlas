                            ...
                            <form name="form1" method="post" action="" id="send">
                                ...
                                <div class="submit-field">
                                    ...
                                    <?php foreach ($payment_methods as $payment) { ?>
                                        <div>
                                            <div class="radio">
                                                <input id="<?php _esc($payment) ?>" name="payment_method"
                                                       type="radio"
                                                       value="<?php _esc($payment) ?>" checked>
                                                <label for="<?php _esc($payment) ?>"><span
                                                            class="radio-label"></span> <?php _esc($payment) ?>
                                                </label>
                                            </div>
                                        </div>
                                    <?php } ?>
                                ...
                                <?php foreach ($withdrawals as $withdrawal) { ?>
                                    <tr>
                                        ...
                                        <td class="padding-left-20">
                                            <?php _esc($withdrawal['payment_method_id']) ?>
