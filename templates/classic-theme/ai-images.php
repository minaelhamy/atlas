        ...
        <div class="dashboard-content-container" data-simplebar>
            <div class="dashboard-content-inner">
                ...
                <form id="ai_images" name="ai_images" method="post" action="#">
                    <h4 class="margin-bottom-10 padding-left-5"><?php _e("Start with a detailed description.") ?> <a
                                href="#" class="try-example"><strong><?php _e("Try an example") ?></strong></a></h4>
                            ...
                            <div class="col-sm-3">
                                <div class="submit-field margin-bottom-20">
                                    ...
                                    <select name="resolution" id="resolution"
                                        ...
                                        <?php $imageModel = normalize_openai_model(get_option('ai_image_openai_model', get_default_openai_image_model()), 'image'); ?>
                                        <?php if ($imageModel != 'gpt-image-1') { ?>
                                            <option value="256x256"><?php _e('256x256') ?></option>
                                            <option value="512x512"><?php _e('512x512') ?></option>
                                        <?php } ?>
                                        <option value="1024x1024"><?php _e('1024x1024') ?></option>
                                        <?php if ($imageModel == 'gpt-image-1') { ?>
                                            <option value="1024x1792"><?php _e('1024x1792') ?></option>
                                            <option value="1792x1024"><?php _e('1792x1024') ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
