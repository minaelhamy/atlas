...
--
-- Table structure for table `<<prefix>>website_sites`
--

DROP TABLE IF EXISTS `<<prefix>>website_sites`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_sites`
(
    `id`               int(11) NOT NULL AUTO_INCREMENT,
    `user_id`          int(11)                                          DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>website_pages`
--

DROP TABLE IF EXISTS `<<prefix>>website_pages`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_pages`
(
    `id`          int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `<<prefix>>website_products`
--

DROP TABLE IF EXISTS `<<prefix>>website_products`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_products`
(
    `id`           int(11) NOT NULL AUTO_INCREMENT,
    `site_id`      int(11)                                          DEFAULT NULL,
    `title`        varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>website_services`
--

DROP TABLE IF EXISTS `<<prefix>>website_services`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_services`
(
    `id`              int(11) NOT NULL AUTO_INCREMENT,
    `site_id`         int(11)                                          DEFAULT NULL,
    `title`           varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>website_orders`
--

DROP TABLE IF EXISTS `<<prefix>>website_orders`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_orders`
(
    `id`            int(11) NOT NULL AUTO_INCREMENT,
    `site_id`       int(11)                                          DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>website_bookings`
--

DROP TABLE IF EXISTS `<<prefix>>website_bookings`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_bookings`
(
    `id`             int(11) NOT NULL AUTO_INCREMENT,
    `site_id`        int(11)                                          DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>website_wallet_ledger`
--

DROP TABLE IF EXISTS `<<prefix>>website_wallet_ledger`;
CREATE TABLE IF NOT EXISTS `<<prefix>>website_wallet_ledger`
(
    `id`             int(11) NOT NULL AUTO_INCREMENT,
    `site_id`        int(11)                                          DEFAULT NULL,
    `user_id`        int(11)                                          DEFAULT NULL,
...
(
    ...
    `translations` LONGTEXT   NULL     DEFAULT NULL,
...
(
    ...
    `training_data`   LONGTEXT   NULL     DEFAULT NULL,
    `translations`    LONGTEXT   NULL     DEFAULT NULL,
